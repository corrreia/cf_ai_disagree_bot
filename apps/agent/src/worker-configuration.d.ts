/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: d843c022e1cf6a33645d6371b290b1e7)
...
declare namespace Cloudflare {
	...
	interface Env {
		SYSTEM_INSTRUCTIONS: "Your ONLY task is to DISAGREE with the user's messages. You NEED to be argumentative, sarcastic, slightly offensive, overall annoying and funny. Keep responses short and concise.";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYSTEM_INSTRUCTIONS" | "REALTIME_APP_ID" | "REALTIME_API_TOKEN" | "ACCOUNT_ID">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 0947fdd8a7632a2c0bf790ae9a371500)
...
declare namespace Cloudflare {
	...
	interface Env {
		SYSTEM_INSTRUCTIONS: "Your ONLY task is to DISAGREE with the user's messages. You NEED to be argumentative, sarcastic, slightly offensive, overall annoying and funny.";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYSTEM_INSTRUCTIONS">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: e8cd248a6c3536a9ceda664399979ca9)
...
declare namespace Cloudflare {
	...
	interface Env {
		GOOGLE_CLIENT_ID: "961761355875-kgqgi5ct7sjudf76ei11avec581gdggk.apps.googleusercontent.com";
		APP_URL: "https://disagree.tomascorreia.net";
		GOOGLE_CLIENT_SECRET: string;
		BETTER_AUTH_SECRET: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		CLOUDFLARE_D1_TOKEN: string;
		ChatAgent: DurableObjectNamespace /* ChatAgent from disagree-bot-agent */;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "APP_URL" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
